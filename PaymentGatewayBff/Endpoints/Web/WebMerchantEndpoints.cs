...
public static class WebMerchantEndpoints
{
    ...
    private record CreateMerchantRequest(string Name, string Email, string Phone, string Country, string City, string Mcc);
    private record UpdateMerchantRequest(Guid Id, string Name, string Email, string Phone, string Country, string City, string Mcc);
    ...
    public static IEndpointRouteBuilder MapWebMerchantEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        app.MapPut("/merchants/{id:guid}", async (Guid id, UpdateMerchantRequest req, MerchantApiClient client, CancellationToken ct) =>
        {
        ...
        app.MapPost("/merchants/{id:guid}/activate", async (Guid id, ReasonRequest req, MerchantApiClient client, CancellationToken ct) =>
        {
        ...
        app.MapPost("/merchants/{id:guid}/deactivate", async (Guid id, ReasonRequest req, MerchantApiClient client, CancellationToken ct) =>
        {
        ...
        app.MapPost("/merchants/{id:guid}/suspend", async (Guid id, ReasonRequest req, MerchantApiClient client, CancellationToken ct) =>
        {
