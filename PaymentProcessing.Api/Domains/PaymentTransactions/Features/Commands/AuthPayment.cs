// namespace PaymentProcessing.Api.Domains.PaymentTransactions.Features.Commands;
//
...
//     {
//         public async Task<(FeatureObjectResultModel<AuthPaymentResponse>, PaymentApprovedIntegration?, PaymentDeclinedIntegration?, PaymentFailedIntegration?)> Handle(
...
//             ));
//
//             PaymentApprovedIntegration? approvedEvent = null;
//             PaymentDeclinedIntegration? declinedEvent = null;
//             PaymentFailedIntegration? failedEvent = null;
//
//             try
//             {
...
//                     ));
//
//                     approvedEvent = new PaymentApprovedIntegration(
//                         transactionId,
//                         merchant.MerchantId,
//                         cmd.OrderId,
//                         cmd.Amount,
...
//                     ));
//
//                     declinedEvent = new PaymentDeclinedIntegration(
//                         transactionId,
//                         merchant.MerchantId,
//                         cmd.OrderId,
//                         grpcResponse.ResultCode,
...
//                 ));
//
//                 failedEvent = new PaymentFailedIntegration(
//                     transactionId,
//                     merchant.MerchantId,
//                     cmd.OrderId,
//                     ex.Status.Detail,
