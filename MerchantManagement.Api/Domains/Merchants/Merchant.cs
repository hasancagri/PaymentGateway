using MerchantManagement.Api.Domains.Merchants.Entities;

namespace MerchantManagement.Api.Domains.Merchants;
...
public sealed class Merchant : AggregateRoot
{
    ...
    [Newtonsoft.Json.JsonProperty] private List<ApiKey> _apiKeys = [];
