...
/// <summary>
/// Payment.Api'nin merchant-scoped kart kasası uç grubu: <c>.../merchants/{merchantId}/vault/cards</c>.
/// Tüm uçlar scope <c>cards.write</c> (capability) + policy <c>MerchantScoped</c> ile korunur —
/// her slice kendi endpoint'inde açıkça beyan eder. Dış sözleşme SABİT (ECommerce tokenizer istemcisi).
/// </summary>
