...
/// <summary>
/// Merchant kartı soft iptal eder (Status=Revoked; fiziksel durur). Idempotent. Sahiplik: kart
/// route <c>{merchantId}</c>'ye ait olmalı (aksi RET) — MerchantScoped'ın üstüne ikinci kapı.
/// </summary>
