...
/// <summary>
/// Merchant PAN'ı tokenize eder → yalnız opak token döner. PAN Luhn/expiry doğrulanır, korunmuş
/// saklanır (enc-at-rest); yanıt PAN/last4/brand/bin TAŞIMAZ (FR: PAN sınırı geçmez).
/// </summary>
public static class TokenizeCard
{
    ...
    /// <summary>HTTP gövdesi — merchantId route'tan gelir, PAN yalnız burada girer.</summary>
