...
/// <summary>
/// Seçilebilir bankaların kanonik katalogu (banka kodu + adı). CP.VPOS <c>BankService.AllBanks</c>'ten
/// statik kopyalanmıştır — CP.VPOS'a runtime bağımlılık yoktur (<c>AllBanks</c> zaten <c>internal</c>,
/// erişilemez). Operatör banka eklerken bu listeden seçer; Bank kaydının adı ve kodu buradan türer.
/// Değişiklik nadir; yeni banka gerekince bu sabit elle güncellenir.
/// </summary>
public static class BankCatalog
{
    ...
    /// <summary>Kod katalogda varsa adını verir. Create doğrulaması + Name türetimi.</summary>
