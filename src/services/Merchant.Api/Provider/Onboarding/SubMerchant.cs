...
{
	public class SubMerchant : ProviderResourceV2
	{
		...
		public static Task<SubMerchant> Create(CreateSubMerchantRequest request, ProviderOptions options)
		{
		...
		public static Task<SubMerchant> Update(UpdateSubMerchantRequest request, ProviderOptions options)
		{
			var uri = options.BaseUrl + "/onboarding/submerchant";
			return RestHttpClientV2.Create().PutAsync<SubMerchant>(uri, GetHttpHeadersWithRequestBody(request, uri, options), request);
		}

		public static Task<SubMerchant> Retrieve(RetrieveSubMerchantRequest request, ProviderOptions options)
		{
