...
/// </summary>
public class MerchantSettlementAccount : AggregateRoot
{
    ...
    private MerchantSettlementAccount()
    {
    }
    ...
    /// </summary>
    public static ResultDomain<MerchantSettlementAccount> Create(
        Guid merchantId,
        string bankCode,
        string iban,
        string ownerName,
        ...
        string description)
    {
        ...
        if (validation is not null)
            return ResultDomain<MerchantSettlementAccount>.Error(validation);

        return ResultDomain<MerchantSettlementAccount>.Ok(new MerchantSettlementAccount
        {
