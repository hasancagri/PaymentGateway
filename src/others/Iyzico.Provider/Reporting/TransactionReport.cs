...
namespace Iyzico.Provider.Reporting
{
    ...
    {
        public static TransactionReport Retrieve(RetrieveTransactionReportRequest request, ProviderOptions options)
        {
        ...
        public static TransactionReport Retrieve(RetrieveScrollTransactionReportRequest request, ProviderOptions options)
        {
