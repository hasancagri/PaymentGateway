...
namespace Iyzico.Provider.Installments
{
	public class BinNumber : ProviderResourceV2
	{
		...
		public static Task<BinNumber> Retrieve(RetrieveBinNumberRequest request, ProviderOptions options)
		{
